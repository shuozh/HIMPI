...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # data aug
        self.parser.add_argument('--up_size', type=int, default=2)
        self.parser.add_argument('--B_dir_train', type=str, default='../RRDataset/Stanford_Lytro77/trainall/')
        self.parser.add_argument('--R_dir_train', type=str, default=None)
        self.parser.add_argument('--dir_test_images', type=str, default='../RRDataset/Stanford_Lytro77/test1_BR_alpha/0.5/')
        self.parser.add_argument('--factor', type=float, default=0.5)
        self.parser.add_argument('--dir_model', type=str, default=None)
        self.parser.add_argument('--if_flip', type=int, default=0, choices=[0, 1])
        self.parser.add_argument('--if_rotation', type=int, default=0, choices=[0, 1])
        ...
        self.parser.add_argument('--crop_size', type=int, default=160)
        self.parser.add_argument('--views', type=int, default=7)

        # loss
        self.parser.add_argument('--loss_weight', type=str, default='1,2,0.05,0.5,0.5,0.5')
        ...
        self.parser.add_argument('--height_view', type=int, default=5)
        self.parser.add_argument('--width_view', type=int, default=5)
        ...
        self.parser.add_argument('--dir_result', type=str, default='./option_save/')
        self.parser.add_argument('--dir_save', type=str, default='/result/')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--tag', type=str, default='all')
    ...
    def parse(self):
        ...
        expr_dir = os.path.join(self.opt.dir_result, self.opt.tag)
        mkdirs(expr_dir)
