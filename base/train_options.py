...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--test_dataload_name', type=str, default='DeRefLF_Test_Dataset_New')

        # data aug
        self.parser.add_argument('--up_size', type=int, default=2)
        self.parser.add_argument('--B_dir_train', type=str, default='./train/')
        ...
        # training
        self.parser.add_argument('--current_iter', type=int, default=870)
        ...
        self.parser.add_argument('--crop_size', type=int, default=120)
        self.parser.add_argument('--views', type=int, default=12)

        # loss
        self.parser.add_argument('--loss_weight', type=str, default='1,1,0.05,0.5,0.5,0,0', help='L1, gard, vgg, L1_step1, BR, Exclusion')
    ...
    def parse(self):
        ...
        expr_dir = os.path.join('./', self.opt.tag)
        mkdirs(expr_dir)
